...
def show_about():
    ...
    """)
    about_msg_box.setWindowTitle("Textio")
...
def show_help():
    ...
    """)
    help_msg_box.setWindowTitle("Textio")
...
class App_Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        """
        self.user_interface.actionZoom_Out.setShortcut("Ctrl+Minus")
    ...
    def closeEvent(self, event):
        ...
        # If it is safe to close then it will ask for user opinion.
            ...
            try:
                # Open message box.
                exit_msg_box = QtWidgets.QMessageBox.question(self, "Textio", "Do you really want to exit",
