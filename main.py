...
class App_Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.user_interface.actionCustom_Theme.triggered.connect(
    ...
    def show_error(self, error):
        ...
        error_msg_box = msg_box.question(self, self.windowTitle, str(error),
    ...
    def apply_custom_theme(self):
        try:
            file_dailog = QtWidgets.QFileDialog.getOpenFileName(
                self, "Custom Theme", ".", "All File (*.*)")
            if file_dailog[0] == "":
                pass

            elif file_dailog[0] != "":
                with open(file_dailog[0], "r") as style_file:
